...
豁免到期=
豁免回收计划=
执行命令=python - <<not-used>>; powershell -File scripts/verify-kit.ps1; powershell -File tests/governance-kit.optimization.tests.ps1; powershell -File scripts/validate-config.ps1; powershell -File scripts/verify.ps1; powershell -File scripts/doctor.ps1
...
增量改动=scripts/automation/run-safe-autopilot.ps1 新增 contract.boundary-classification；新增 preflight 脚本存在性检查；dry-run planned_order 更新；tests/governance-kit.optimization.tests.ps1 的4个run-safe-autopilot用例补充 scripts/governance/check-boundary-classification.ps1 夹具
增量验证命令=powershell -File tests/governance-kit.optimization.tests.ps1; powershell -File scripts/verify-kit.ps1; powershell -File tests/governance-kit.optimization.tests.ps1; powershell -File scripts/validate-config.ps1; powershell -File scripts/verify.ps1; powershell -File scripts/doctor.ps1
