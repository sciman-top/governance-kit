...
影响模块=scripts/lib/common.ps1;scripts/install.ps1;scripts/verify.ps1;scripts/run-project-governance-cycle.ps1;scripts/governance/run-target-autopilot.ps1;scripts/suggest-release-profile.ps1;scripts/verify-release-profile.ps1;tests/governance-kit.optimization.tests.ps1
当前落点=E:/CODE/governance-kit/scripts/*
目标归宿=E:/CODE/governance-kit/source/project/_common/custom/scripts/governance/run-target-autopilot.ps1 + 仓内脚本公共能力统一
...
豁免到期=N/A
豁免回收计划=N/A
执行命令=codex --version; codex --help; codex status; powershell -File scripts/verify-kit.ps1; powershell -File tests/governance-kit.optimization.tests.ps1; powershell -File scripts/validate-config.ps1; powershell -File scripts/verify.ps1; powershell -File scripts/doctor.ps1
...
回滚动作=git checkout -- scripts/lib/common.ps1 scripts/install.ps1 scripts/verify.ps1 scripts/run-project-governance-cycle.ps1 scripts/governance/run-target-autopilot.ps1 scripts/suggest-release-profile.ps1 scripts/verify-release-profile.ps1 tests/governance-kit.optimization.tests.ps1 source/project/_common/custom/scripts/governance/run-target-autopilot.ps1
...
追加落点=E:/CODE/governance-kit/scripts/lib/common.ps1;E:/CODE/governance-kit/tests/governance-kit.optimization.tests.ps1
...
追加验证命令=PowerShell AST parse all ps1/psm1; git diff --check; powershell -File scripts/verify-kit.ps1; powershell -File tests/governance-kit.optimization.tests.ps1; powershell -File scripts/validate-config.ps1; powershell -File scripts/verify.ps1; powershell -File scripts/doctor.ps1
...
追加回滚动作=git checkout -- scripts/lib/common.ps1 tests/governance-kit.optimization.tests.ps1 docs/change-evidence/20260409-governance-hardening-refactor.md
...
追加落点2=E:/CODE/governance-kit/scripts/lib/common.ps1;E:/CODE/governance-kit/tests/governance-kit.optimization.tests.ps1
...
追加验证命令2=PowerShell AST parse all ps1/psm1; powershell -File tests/governance-kit.optimization.tests.ps1; powershell -File scripts/verify-kit.ps1; powershell -File scripts/validate-config.ps1; powershell -File scripts/verify.ps1; powershell -File scripts/doctor.ps1
追加验证证据2=parse_ok files=86; tests all pass(~98s incremental/~146s full gate chain); governance-kit integrity OK; Config validation passed repositories=3 targets=106 rolloutRepos=1; Verify done ok=106 fail=0; doctor HEALTH=GREEN
追加回滚动作2=git checkout -- scripts/lib/common.ps1 tests/governance-kit.optimization.tests.ps1 docs/change-evidence/20260409-governance-hardening-refactor.md
...
追加落点3=E:/CODE/governance-kit/tests/governance-kit.optimization.tests.ps1
...
追加验证命令3=PowerShell AST parse all ps1/psm1; powershell -File tests/governance-kit.optimization.tests.ps1; powershell -File scripts/verify-kit.ps1; powershell -File scripts/validate-config.ps1; powershell -File scripts/verify.ps1; powershell -File scripts/doctor.ps1
追加验证证据3=parse_ok files=86; tests all pass(~107s incremental/~119s full gate chain); governance-kit integrity OK; Config validation passed repositories=3 targets=106 rolloutRepos=1; Verify done ok=106 fail=0; doctor HEALTH=GREEN
追加回滚动作3=git checkout -- tests/governance-kit.optimization.tests.ps1 docs/change-evidence/20260409-governance-hardening-refactor.md
...
追加落点5=E:/CODE/governance-kit/source/project/_common/custom/.codex/config.toml
...
追加验证证据5=governance-kit/ClassroomToolkit/skills-manager 三仓 .codex/config.toml 均为 workspace-write + network_access=true; install post-gate passed; doctor HEALTH=GREEN
...
追加落点6=E:/CODE/governance-kit/scripts/set-codex-runtime-policy.ps1
...
追加落点7=E:/CODE/governance-kit/scripts/validate-config.ps1;E:/CODE/governance-kit/scripts/install.ps1
...
追加落点8=E:/CODE/governance-kit/scripts/validate-config.ps1
...
追加落点4=E:/CODE/governance-kit/source/project/_common/custom/.codex/config.toml
...
追加分发4=powershell -NoProfile -ExecutionPolicy Bypass -File scripts/install.ps1 -Mode safe (copied=3 to governance-kit/ClassroomToolkit/skills-manager .codex/config.toml)
...
alternative_verification=PowerShell AST parse all ps1/psm1 + tests/governance-kit.optimization.tests.ps1 + fixed gates
...
alternative_verification=记录codex --version/codex --help + active_rule_path=E:/CODE/governance-kit/AGENTS.md
...
追加落点9=E:/CODE/governance-kit/scripts/validate-config.ps1
...
追加落点10=E:/CODE/governance-kit/scripts/status.ps1;E:/CODE/governance-kit/scripts/rollout-status.ps1
...
追加落点11=E:/CODE/governance-kit/scripts/install.ps1
...
追加落点12=E:/CODE/governance-kit/scripts/set-rollout.ps1;E:/CODE/governance-kit/scripts/restore.ps1;E:/CODE/governance-kit/scripts/check-waivers.ps1
...
追加验证命令12=powershell -NoProfile -ExecutionPolicy Bypass -File scripts/check-waivers.ps1; powershell -NoProfile -ExecutionPolicy Bypass -File scripts/set-rollout.ps1 -RepoPath E:/CODE/governance-kit -Mode plan -Phase observe; powershell -NoProfile -ExecutionPolicy Bypass -File tests/governance-kit.optimization.tests.ps1; powershell -NoProfile -ExecutionPolicy Bypass -File scripts/verify-kit.ps1; powershell -NoProfile -ExecutionPolicy Bypass -File scripts/validate-config.ps1; powershell -NoProfile -ExecutionPolicy Bypass -File scripts/verify.ps1; powershell -NoProfile -ExecutionPolicy Bypass -File scripts/doctor.ps1
...
追加落点13=E:/CODE/governance-kit/scripts/verify.ps1
...
追加验证命令13=powershell -NoProfile -ExecutionPolicy Bypass -File scripts/verify.ps1; powershell -NoProfile -ExecutionPolicy Bypass -File tests/governance-kit.optimization.tests.ps1; powershell -NoProfile -ExecutionPolicy Bypass -File scripts/doctor.ps1
...
追加落点14=E:/CODE/governance-kit/scripts/add-repo.ps1;E:/CODE/governance-kit/scripts/remove-repo.ps1;E:/CODE/governance-kit/scripts/run-real-repo-regression.ps1
...
追加验证命令14=powershell -NoProfile -ExecutionPolicy Bypass -File scripts/add-repo.ps1 -RepoPath E:/CODE/governance-kit -Mode plan; powershell -NoProfile -ExecutionPolicy Bypass -File scripts/remove-repo.ps1 -RepoPath E:/CODE/governance-kit -Mode plan; powershell -NoProfile -ExecutionPolicy Bypass -File scripts/run-real-repo-regression.ps1 -Mode plan; powershell -NoProfile -ExecutionPolicy Bypass -File tests/governance-kit.optimization.tests.ps1; powershell -NoProfile -ExecutionPolicy Bypass -File scripts/verify-kit.ps1
...
追加落点15=E:/CODE/governance-kit/scripts/governance/check-update-triggers.ps1;E:/CODE/governance-kit/source/project/governance-kit/custom/scripts/governance/check-update-triggers.ps1
...
追加回滚动作15=git checkout -- scripts/governance/check-update-triggers.ps1 source/project/governance-kit/custom/scripts/governance/check-update-triggers.ps1 docs/change-evidence/20260409-governance-hardening-refactor.md

追加审查16=2026-04-10 doctor clarification-observability JSON read-path unification
追加落点16=E:/CODE/governance-kit/scripts/doctor.ps1
...
追加落点17=E:/CODE/governance-kit/scripts/check-orphan-custom-sources.ps1;E:/CODE/governance-kit/scripts/audit-governance-readiness.ps1
