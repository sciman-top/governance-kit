...
影响模块=scripts/set-codex-runtime-policy.ps1; scripts/verify-kit.ps1; tests/governance-kit.optimization.tests.ps1; README.md
...
回滚动作=git revert scripts/set-codex-runtime-policy.ps1 scripts/verify-kit.ps1 tests/governance-kit.optimization.tests.ps1 README.md
