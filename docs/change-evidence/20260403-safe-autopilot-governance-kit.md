...
回滚动作=git checkout -- scripts/automation/run-safe-autopilot.ps1 docs/change-evidence/20260403-safe-autopilot-governance-kit.md

platform_na=reason: codex status 在非交互终端失败（stdin is not a terminal） | alternative_verification: 使用 codex --version 与 codex --help 补充平台能力验证 | evidence_link: docs/change-evidence/20260403-safe-autopilot-governance-kit.md | expires_at: 2026-04-30
