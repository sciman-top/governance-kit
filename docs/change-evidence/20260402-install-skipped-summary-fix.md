...
影响模块=scripts/install.ps1, tests/repo-governance-hub.optimization.tests.ps1
当前落点=E:/CODE/repo-governance-hub/{scripts,tests}
目标归宿=E:/CODE/repo-governance-hub/source/project/repo-governance-hub/* (规则源) + 安装分发目标
