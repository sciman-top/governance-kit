...
豁免到期=
豁免回收计划=
执行命令=powershell -NoProfile -ExecutionPolicy Bypass -File scripts/install-full-stack.ps1 -RepoPath E:\CODE\governance-kit -Mode plan -SkipAutopilotSmoke -SkipTargetPrecheck -SkipTargetGate; PowerShell Parser::ParseFile(scripts/install-full-stack.ps1)
