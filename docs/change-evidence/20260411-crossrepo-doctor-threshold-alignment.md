...
当前落点=E:/CODE/governance-kit + E:/CODE/skills-manager
...
术语解释点=source of truth: 应在规则/策略真实归宿仓先修复再分发; 本次示例为 governance-kit 的 source/project/skills-manager/*
...
命令=governance-kit: verify-kit/test/validate-config/verify/doctor; install.ps1 -Mode safe
命令=skills-manager: build.ps1; skills.ps1 发现; skills.ps1 doctor --strict --threshold-ms 8000; skills.ps1 构建生效
关键输出=governance-kit verify done ok=187 fail=0; doctor HEALTH=GREEN
...
回滚动作=git -C E:/CODE/governance-kit checkout -- source/project/skills-manager/AGENTS.md source/project/skills-manager/CLAUDE.md source/project/skills-manager/GEMINI.md
