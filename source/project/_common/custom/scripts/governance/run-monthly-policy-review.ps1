...
[void]$lines.Add(("skill_lifecycle_status={0}" -f [string]$review.summary.skill_lifecycle_status))
[void]$lines.Add(("skill_lifecycle_merge_candidate_count={0}" -f [int]$review.summary.skill_lifecycle_merge_candidate_count))
[void]$lines.Add(("skill_lifecycle_retire_candidate_count={0}" -f [int]$review.summary.skill_lifecycle_retire_candidate_count))
[void]$lines.Add(("skill_lifecycle_applied_merge_count={0}" -f [int]$review.summary.skill_lifecycle_applied_merge_count))
[void]$lines.Add(("skill_lifecycle_applied_retire_count={0}" -f [int]$review.summary.skill_lifecycle_applied_retire_count))
...
if ([bool]$review.ok) {
  ...
  [void]$lines.Add("- Run skill lifecycle review and apply merge/retire actions in safe mode when evidence is sufficient.")
